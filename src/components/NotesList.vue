...
article {
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); /* Colonne di larghezza fissa */
    padding: 1em;
    gap: 1em;
}
...
section {
    display: grid;
    grid-template-rows: auto 1fr auto; /* Una riga per il pulsante, una per il testo principale, una per la data */
    height: 300px;
...
.date {
    font-size: 0.8em;
    justify-self: start; /* Allineamento della data a sinistra */
}

.close {
    justify-self: end; /* Allineamento del pulsante X a destra */
